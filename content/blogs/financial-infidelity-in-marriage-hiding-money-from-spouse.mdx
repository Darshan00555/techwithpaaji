...
- Financial infidelity is deliberate concealment of money facts from a spouse — hidden debt, secret accounts, undisclosed lending or losses.
- The damage comes from the concealment rather than the amount; a small hidden purchase and a large hidden loan share the same mechanism.
- Recovery requires full disclosure at once, not in instalments — staged revelation restarts the injury each time.
- Rebuilding usually needs a period of agreed transparency, time-limited and consented to, rather than permanent surveillance.
